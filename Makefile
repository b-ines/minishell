...
CFILES = main/main.c main/signals.c main/early_parser.c main/terminal_init.c \
	...
	parser/syntax_check_utils.c parser/syntax_check.c parser/syntax_check_redir.c parser/cmd_hd_list.c parser/print_cmd.c parser/append_lists.c parser/parser.c parser/inf_outf_list.c \
